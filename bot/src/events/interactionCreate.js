        ...
        try {
            ...
            if (interaction.isStringSelectMenu() && cid?.startsWith("pagamento_")) {
                ...
                const embedTicket = new EmbedBuilder()
                    ...
                    .setDescription(`📦 **Produto:** ${tipoProd}\n<:threedots:1521920058140659803> **Staff:**  Aguardando...\n💳 **Metodo:** ${emoji} ${metodo}`)
                    .setColor("#2f3136");
            ...
            if (cid === "call_staff_list") {
                ...
                // REMOVER DUPLICADOS - usar Map para garantir unico por ID
                ...
                const staffOnline = Array.from(staffMap.values())
            ...
            if (cid === "notify_staff_id") {
                ...
                const embedDM = new EmbedBuilder()
                    ...
                    .setDescription(`O cliente **${user.username}** chamou-te em <#${channel.id}>`)
                    .setColor("#f1c40f");
